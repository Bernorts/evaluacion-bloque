...
class EvaluationsController < ApplicationController
  ...
  def create
    ...
    ActiveRecord::Base.transaction do
      ...
      @error = true unless @interview.save!
      ...
      @selected_competences.each do |key, value|
        ...
        if !@evaluation.save!
          ...
          @selected_evidences.each do |e|
            ...
            unless @evaluation_evidence.save!
              @error = true
              break
            end
          end
  ...
  def destroy
    ...
    @evaluations.each do |eval|
      unless eval.achLevel.nil?
        @error = true
        break
      end
      unless EvaluationEvidence.destroy_all(evaluation_id: eval.id) && eval.destroy
        @error = true
        break
      end
    end
    @error = true unless @interview.destroy
    if !@error
