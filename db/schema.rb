...
ActiveRecord::Schema.define(version: 20_210_729_052_947) do
  ...
  create_table 'competence_semesters', id: false, force: :cascade do |t|
    t.integer 'competence_id', null: false
    t.integer 'semester_id',   null: false
    t.index ['competence_id'], name: 'index_competence_semesters_on_competence_id', using: :btree
    t.index ['semester_id'], name: 'index_competence_semesters_on_semester_id', using: :btree
  end
  ...
  create_table 'evaluations_users', force: :cascade do |t|
    ...
    t.datetime 'updated_at',     null: false
    t.string   'retro'
    t.index %w[evaluation_id user_id], name: 'index_evaluations_users_on_evaluation_id_and_user_id', unique: true, using: :btree
  end
